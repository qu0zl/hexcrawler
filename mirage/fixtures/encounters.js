export default [
    ...
    {id: 'CT1', title: '!d[2d10] bars of platinum worth 250gp each'},
    {id: 'CT2', title: '!d[3d10] gems worth 200gp each'},
    {id: 'CT3', title: '!d[1d4] rolls of silk, unearthly quality, worth 2000gp each'},
    {id: 'CT4', title: 'Cage of !d[1d4+4] adorable, furry little pet-things of unknown species or origin, worth 1000gp each.'},
    {id: 'CT5', title: '!d[1d6+1] potions (determine randomly from tables in rulebook)'},
    {id: 'CT6', title: '!d[1d6+8] potions (determine randomly from tables in rulebook)'},
    {id: 'CT7', title: '!d[1d4] scrolls (determine randomly from tables in rulebook)'},
    {id: 'CT8', title: '1 magic item of any kind (determine randomly from tables in rulebook)'},
    {id: 'CT9', title: '2 magic items of any kind (determine randomly from tables in rulebook)'},
    {id: 'CT10', title: '3 magic items of any kind (determine randomly from tables in rulebook)'},
];
